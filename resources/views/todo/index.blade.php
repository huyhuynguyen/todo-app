...
<link rel="stylesheet" href="{{ asset('css/todo_list.css') }}">
    <div class="main__wrapper">
        ...
        <div class="main__btn-create-container">
            <a href="/todolist/create" class="main__btn-create-link">
                <button class="main__btn-create">Create Todo</button>
            </a>
        </div>
            ...
            <div class="main__search-container">
                <form action="/todolist/search" method="post" class="main__form-search">
                    ...
                    <div class="form__group">
                        <input type="search" name="search" class="form__group-input-search" placeholder="Search..." title="search todo">
                    </div>
                    <div class="form__group">
